...
Se tiene el conjunto universal $U$ representado por el alfabeto inglés. Por otro lado, se tienen los conjunto $$A= \left\{d, s, l, y, h, t, b, u, f, n  \right\}.$$ y $$B= \left\{p, y, u, m, k, f, r, j, h, n  \right\}.$$
...
Dados los conjuntos $A$, $B$, especificados en el ejemplo  \@ref(exm:ejemp1-diferencia), determine $A \oplus BB$ y $B \oplus A$ y verifique la propiedad conmutativa de la diferencia simétrica.
