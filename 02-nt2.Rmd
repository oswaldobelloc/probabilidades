...
::: {#subconjunto .definition name="Conjunto Contable"}
...
1.	$A \subseteq A$
2.	Si $A \subseteq B$ y $B \supseteq A$, entonces $A=B$
...
1. $(A \cap B) \cap C=A \cap (B \cap C)$. (Asociativa)

1. $(A \cap B) \subseteq A$.

1. $(A \cap B)\subseteq B$.

::: {.example #ejemp1-interseccion name="Intersección"}
...
1. $(A \cup B) \cup C=A \cup (B \cup C)$.  (Asociativa)
