...
Este libro es una guía para la enseñanza de la asignatura Probabilidades, esencialmente pretende ser un curso de Probabilidades Discretas aplicado con el lenguaje `r colorize("R", "blue")`. 
