...
Este libro es una guía para la enseñanza de la asignatura Probabilidades, esencialmente pretende ser un curso de Probabilidades Discretas aplicado con el lenguaje de programación `r colorize("R", "blue")` el cual puede descargar en [R](https://cran.r-project.org/). 
